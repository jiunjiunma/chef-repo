...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jiunjiunma-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jma"
  #   chef.validation_client_name = "jma-validator"
  #   chef.validation_key_path = ".chef/jma-validator.pem"
  # end
end
